...
```javascript
ceil = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-ceil@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-base-special-ceil/tags). For example,

```javascript
ceil = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-ceil@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var ceil = require( 'path/to/vendor/umd/math-base-special-ceil/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-ceil/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/math-base-special-ceil/actions/workflows/test.yml?query=branch:v0.1.1
